...
book_genre = Table(
    'book_genre',
    Base.metadata,
    Column('book_id', UUID(as_uuid=True), ForeignKey('book.id', ondelete='CASCADE'), primary_key=True),
...
book_contributor = Table(
    ...
    Base.metadata,
    Column('book_id', UUID(as_uuid=True), ForeignKey('book.id', ondelete='CASCADE'), primary_key=True),
    Column('contributor_id', UUID(as_uuid=True), ForeignKey('contributor.id', ondelete='CASCADE'), primary_key=True),
