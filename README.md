...
- Вынесение всех текстовых сообщений об ошибках в отдельный файл констант для централизованного управления текстами, предотвращения дублирования кода и улучшения читаемости
---
